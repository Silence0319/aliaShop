<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:80:"D:\phpstudy_pro\WWW\www.alia.com\public/../application/admin\view\user\list.html";i:1589441260;s:84:"D:\phpstudy_pro\WWW\www.alia.com\public/../application/admin\view\common\header.html";i:1585637248;}*/ ?>
<!DOCTYPE html>
                ...
                <div class="layui-col-md12">
                    <div class="layui-card">
                        ...
                        <div class="layui-card-header">
                            ...
                            <button class="layui-btn" onclick="xadmin.open('添加用户','<?php echo url('user/add'); ?>',850,700)"><i class="layui-icon"></i>添加</button>
                        </div>
                            ...
                            <table class="layui-table layui-form">
                                ...
                                <tbody>
                                  ...
                                  <tr>
                                    ...
                                    <th><?php echo $vo['inTime']; ?></th>
                                    <th><?php echo $vo['province']; ?><?php echo $vo['city']; ?><?php echo $vo['area']; ?> <?php echo $vo['address']; ?></th>
                                    <td class="td-status">
                                      <?php if($vo['status'] == 1): ?>
                                    ...
                                    <td class="td-manage">
                                      ...
                                      <?php endif; ?>
                                      <a title="编辑"  onclick="xadmin.open('编辑','<?php echo url('user/edit',array('id'=>$vo['id'])); ?>',850,700)" href="javascript:;">
                                        <i class="layui-icon">&#xe642;</i>
                                      </a>
                                      <a onclick="xadmin.open('修改密码','<?php echo url('user/password',array('id'=>$vo['id'])); ?>',600,400)" title="修改密码" href="javascript:;">
                                        <i class="layui-icon">&#xe631;</i>
                                      </a>
    ...
    <script>
      ...
      function member_stop(obj,id){
        if($(obj).attr('title')=='停用'){
          layer.confirm('确认要停用吗？',function(index){
            //发异步把用户状态进行更改
            $.get("<?php echo url('user/stop'); ?>",{id:id});
            $(obj).attr('title','启用')
            $(obj).find('i').html('&#xe62f;');
          ...
          //发异步把用户状态进行更改
          $.get("<?php echo url('user/start'); ?>",{id:id});
          $(obj).attr('title','停用')
          $(obj).find('i').html('&#xe601;');
      ...
      function member_del(obj,id){
          layer.confirm('确认要删除吗？',function(index){
              //发异步删除数据
              $.get("<?php echo url('del/user'); ?>",{id:id});
