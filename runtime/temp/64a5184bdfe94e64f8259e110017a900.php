<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:81:"D:\phpstudy_pro\WWW\www.alia.com\public/../application/admin\view\banner\add.html";i:1587029030;s:84:"D:\phpstudy_pro\WWW\www.alia.com\public/../application/admin\view\common\header.html";i:1585637248;}*/ ?>
<!DOCTYPE html>
    ...
    <body>
        ...
        layui.use(['upload','form','layer','laydate'], function() {
            ...
            form.on('submit(formDemo)', function(data){
                ...
                $.ajax({
                    type:'post',
                    url:'<?php echo url('add/bannerLink'); ?>?imgSrc='+imgSrc+'&'+p_id,
                    dateType:'json',
