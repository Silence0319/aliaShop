<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:84:"D:\phpstudy_pro\WWW\www.alia.com\public/../application/index\view\news\newsinfo.html";i:1589510971;s:84:"D:\phpstudy_pro\WWW\www.alia.com\public/../application/index\view\common\header.html";i:1589248378;s:84:"D:\phpstudy_pro\WWW\www.alia.com\public/../application/index\view\common\footer.html";i:1584860727;}*/ ?>
      ...
      <div class="commod-cont w1200 layui-clear">
        <div class="left-nav" style="width: 100px;">
          <div class="list-boxs" style="width: 100px;">
            <ul>
              ...
              <a href="<?php echo url('news/index',array('id'=>$vo['id'])); ?>"><li><?php echo $vo['catename']; ?></li></a>
        ...
        <div class="right-cont-wrap">
          <div class="right-cont" style="background-color: #fff;min-height: 500px;height: auto;padding: 10px 25px 30px 25px;">
            ...
            <div style="text-align: center;color: #bbb;padding: 0 0 20px 0;">
              时间：<?php echo $news['putTime']; ?> &nbsp;栏目：<?php echo $news['catename']; ?>
            </div>
            <div><?php echo $news['content']; ?></div>
          </div>
          <div style="background-color: #fff;padding: 0px 15px 25px 35px;width: 1000px;color: #333;"><a href="<?php echo $news['url']; ?>" target="_blank">来源:<?php echo $news['source']; ?></a></div>
        </div>
      </div>
    </div>
  </div>
