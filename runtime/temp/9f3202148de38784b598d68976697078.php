<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:85:"D:\phpstudy_pro\WWW\www.alia.com\public/../application/admin\view\admin\password.html";i:1587457356;s:84:"D:\phpstudy_pro\WWW\www.alia.com\public/../application/admin\view\common\header.html";i:1585637248;}*/ ?>
<!DOCTYPE html>
                ...
                <form class="layui-form" id="formData">
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-inline">
                            <input type="text" id="L_adminname" name="adminname" disabled="" value="<?php echo $admin['name']; ?>" class="layui-input">
