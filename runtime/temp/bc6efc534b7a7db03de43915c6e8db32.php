<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:81:"D:\phpstudy_pro\WWW\www.alia.com\public/../application/admin\view\admin\edit.html";i:1585885336;s:84:"D:\phpstudy_pro\WWW\www.alia.com\public/../application/admin\view\common\header.html";i:1585637248;}*/ ?>
<!DOCTYPE html>
            ...
            <div class="layui-row">
                <form class="layui-form" id="formData">
                  ...
                  <div class="layui-form-item">
                      ...
                      <div class="layui-input-inline">
                          <input type="text" id="phone" name="phone" value="<?php echo $admin['phone']; ?>" required="" lay-verify="phone"
                          autocomplete="off" class="layui-input">
                      </div>
                  </div>
