  ...
  $("#price").click(function(){
    ...
    function list(start,size){
      var cid=$("#cid").val();
        $.ajax({
            type:"post",
            url:"<?php echo url('all/sonPrice'); ?>",
            data:{start: start,size: size,subject_chapter_no: "<?php echo $discussionNum; ?>",cid:cid},
            timeout:10000,
            error:function (){
                alert('发送请求超时，请稍后重试');
                //console.log("请求失败");
  ...
  $("#newprod").click(function(){
    ...
    function list(start,size){
      var cid=$("#cid").val();
        $.ajax({
            type:"post",
            url:"<?php echo url('all/sonNewprod'); ?>",
            data:{start: start,size: size,subject_chapter_no: "<?php echo $discussionNum; ?>",cid:cid},
            timeout:10000,
            error:function (){
                alert('发送请求超时，请稍后重试');
  ...
  $("#collection").click(function(){
    ...
    function list(start,size){
      var cid=$("#cid").val();
        $.ajax({
            type:"post",
            url:"<?php echo url('all/sonCollection'); ?>",
            data:{start: start,size: size,subject_chapter_no: "<?php echo $discussionNum; ?>",cid:cid},
            timeout:10000,
            error:function (){
                alert('发送请求超时，请稍后重试');
