<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:80:"D:\phpstudy_pro\WWW\www.alia.com\public/../application/admin\view\news\edit.html";i:1587196644;s:84:"D:\phpstudy_pro\WWW\www.alia.com\public/../application/admin\view\common\header.html";i:1585637248;}*/ ?>
<!DOCTYPE html>
			...
			<form class="layui-form" action="" id="formData">
				<div class="layui-form-item">
					...
					<div class="layui-input-inline shortInput">
						<input type="text" name="title" value="<?php echo $news['title']; ?>" required lay-verify="title" autocomplete="off" class="layui-input">
				...
				<div class="layui-form-item">
	                ...
	                <div class="layui-input-inline" style="position: relative;z-index: 10000;">
	                    <select name="twolevel" id="twolevel" lay-filter="twolevel">
	                        <option value="<?php echo $news['c_id']; ?>"><?php echo $news['catename']; ?></option>
	                    </select>
	                </div>
				</div>
				...
				<div class="layui-form-item">
					...
					<div class="layui-input-inline shortInput">
						<input type="text" name="url" value="<?php echo $news['url']; ?>" required lay-verify="url" placeholder="" autocomplete="off" class="layui-input">
					</div>
				</div>
				<div class="layui-form-item">
					<label class="layui-form-label">来源</label>
					<div class="layui-input-inline shortInput">
						<input type="text" name="source" value="<?php echo $news['source']; ?>" required lay-verify="source" placeholder="" autocomplete="off" class="layui-input">
					</div>
				</div>
				<div class="layui-form-item">
					<label class="layui-form-label">内容</label>
					<div class="layui-input-inline shortInput">
						<textarea name="content" id="editor" type="text/plain" style="width: 900px; height:400px;"><?php echo $news['content']; ?></textarea>
					</div>
				</div>
