<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:81:"D:\phpstudy_pro\WWW\www.alia.com\public/../application/index\view\all\search.html";i:1589275823;s:84:"D:\phpstudy_pro\WWW\www.alia.com\public/../application/index\view\common\footer.html";i:1584860727;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="UTF-8">
      ...
      <div class="headerCon">
        ...
        <div class="mallSearch">
          <form action="<?php echo url('all/search'); ?>" class="layui-form" novalidate>
            <input type="text" name="keyword" required  lay-verify="required" autocomplete="off" class="layui-input" placeholder="请输入需要的商品" value="<?php echo $keyword; ?>">
...
$(document).ready(function(){
  $("#price").click(function(){
    ...
    function list(start,size){
      console.log(keyword);
        $.ajax({
            type:"post",
            url:"<?php echo url('all/searchPrice'); ?>",
            data:{start: start,size: size,subject_chapter_no: "<?php echo $discussionNum; ?>",keyword:"<?php echo $keyword; ?>"},
            timeout:10000,
            error:function (){
                alert('发送请求超时，请稍后重试');
                //console.log("请求失败");
  ...
  $("#volume").click(function(){
    ...
    function list(start,size){
        $.ajax({
            type:"post",
            url:"<?php echo url('all/searchVolume'); ?>",
            data:{start: start,size: size,subject_chapter_no: "<?php echo $discussionNum; ?>",keyword:"<?php echo $keyword; ?>"},
            timeout:10000,
            error:function (){
                alert('发送请求超时，请稍后重试');
  ...
  $("#newprod").click(function(){
    ...
    function list(start,size){
      var cid=$("#cid").val();
        $.ajax({
            type:"post",
            url:"<?php echo url('all/searchNewprod'); ?>",
            data:{start: start,size: size,subject_chapter_no: "<?php echo $discussionNum; ?>",keyword:"<?php echo $keyword; ?>"},
            timeout:10000,
            error:function (){
                alert('发送请求超时，请稍后重试');
  ...
  $("#collection").click(function(){
    ...
    function list(start,size){
      var cid=$("#cid").val();
        $.ajax({
            type:"post",
            url:"<?php echo url('all/searchCollection'); ?>",
            data:{start: start,size: size,subject_chapter_no: "<?php echo $discussionNum; ?>",keyword:"<?php echo $keyword; ?>"},
            timeout:10000,
            error:function (){
                alert('发送请求超时，请稍后重试');
...
function list(start,size){
        ...
        $.ajax({
            type:"post",
            url:"<?php echo url('all/searchdata'); ?>",
            data:{start: start,size: size,subject_chapter_no: "<?php echo $discussionNum; ?>",keyword:"<?php echo $keyword; ?>"},
            timeout:10000,
            error:function (){
                alert('发送请求超时，请稍后重试');
