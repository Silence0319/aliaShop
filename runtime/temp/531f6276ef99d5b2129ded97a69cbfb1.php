<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:81:"D:\phpstudy_pro\WWW\www.alia.com\public/../application/admin\view\admin\list.html";i:1589442977;s:84:"D:\phpstudy_pro\WWW\www.alia.com\public/../application/admin\view\common\header.html";i:1585637248;}*/ ?>
<!DOCTYPE html>
                ...
                <div class="layui-col-md12">
                    <div class="layui-card">
                        ...
                        <div class="layui-card-header">
                            ...
                            <button class="layui-btn" onclick="xadmin.open('添加管理员','<?php echo url('admin/add'); ?>',700,500)"><i class="layui-icon"></i>添加</button>
                        </div>
                        <div class="layui-card-body ">
                                ...
                                <tr>
                                  ...
                                  <td class="td-manage">
                                    <?php if($vo['status'] == 1): ?>
                                      ...
                                      <?php endif; ?>
                                    <a title="编辑"  onclick="xadmin.open('编辑','<?php echo url('admin/edit',array('id'=>$vo['id'])); ?>',700,500)" href="javascript:;">
                                      <i class="layui-icon">&#xe642;</i>
                                    </a>
                                    <a onclick="xadmin.open('修改密码','<?php echo url('admin/password',array('id'=>$vo['id'])); ?>',600,400)" title="修改密码" href="javascript:;">
                                        <i class="layui-icon">&#xe631;</i>
                                      </a>
    ...
    <script>
      ...
      function member_stop(obj,id){
        if($(obj).attr('title')=='停用'){
          layer.confirm('确认要停用吗？',function(index){
            //发异步把用户状态进行更改
            $.get("<?php echo url('admin/stop'); ?>",{id:id});
            $(obj).attr('title','启用')
            $(obj).find('i').html('&#xe62f;');
          ...
          //发异步把用户状态进行更改
          $.get("<?php echo url('admin/start'); ?>",{id:id});
          $(obj).attr('title','停用')
          $(obj).find('i').html('&#xe601;');
      ...
      function member_del(obj,id){
          layer.confirm('确认要删除吗？',function(index){
              //发异步删除数据
              $.get("<?php echo url('del/admin'); ?>",{id:id});
