<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:82:"D:\phpstudy_pro\WWW\www.alia.com\public/../application/admin\view\cate\twoadd.html";i:1585879438;s:84:"D:\phpstudy_pro\WWW\www.alia.com\public/../application/admin\view\common\header.html";i:1585637248;}*/ ?>
<!DOCTYPE html>
                ...
                <form class="layui-form" id="formData">
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-inline">
                            <input type="text" id="L_username" name="" value="<?php echo $cate['catename']; ?>" disabled="" class="layui-input">
                            <input type="hidden" name="tid" value="<?php echo $cate['id']; ?>">
                        </div>
                    </div>
                    <div class="layui-form-item">
