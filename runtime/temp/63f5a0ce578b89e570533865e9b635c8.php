<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:84:"D:\phpstudy_pro\WWW\www.alia.com\public/../application/admin\view\product\today.html";i:1589444304;s:84:"D:\phpstudy_pro\WWW\www.alia.com\public/../application/admin\view\common\header.html";i:1585637248;}*/ ?>
<!DOCTYPE html>
<html class="x-admin-sm">
                    ...
                    <div class="layui-card">
                        ...
                        <div class="layui-card-body ">
                            <table class="layui-table layui-form">
                                ...
                                <tbody>
                                    <?php if(is_array($today) || $today instanceof \think\Collection || $today instanceof \think\Paginator): $i = 0; $__LIST__ = $today;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                                    <tr>
                                        <td>
                                        ...
                                        <td class="td-manage">
                                            ...
                                            <a title="移除今日团购" onclick="today_del(this,'<?php echo $vo['id']; ?>')" href="javascript:;">
    ...
    <script>layui.use(['laydate', 'form'],
        ...
        function today_del(obj, id) {
            ...
            function(index) {
                //发异步删除数据
                $.get("<?php echo url('del/todaybuy'); ?>",{id:id});
